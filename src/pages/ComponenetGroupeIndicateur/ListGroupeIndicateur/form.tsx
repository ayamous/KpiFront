...
const FormGroupeIndicateurListe = () => {
...
const groupeIndicateur={
  ...
  useEffect(() => {
    axiosInstance.get('/kpi-groups?page='+page+'&label='+searchInput).then((res) => {
                  ...
                  <div className="formlist">
                    <div className="d-flex justify-content-between divPParent">
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <button id={item.id.toString()} onClick={delete_groupeIndicateur} className="clsbgL"><i><img src={index == currentactif && !show ?"./assets/images/deleteIcon.svg":"./assets/images/deleteIcon.svg"} alt="deleteIcon" /></i></button>
...
export default FormGroupeIndicateurListe;
